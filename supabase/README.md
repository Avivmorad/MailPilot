...
Database schema and migrations for GmailPilot.

- `migrations/` — SQL migrations, committed to the repository. Added from Phase 1 onward.
  - `0001_profiles.sql` — app profiles.
  - `0002_gmail_connections.sql` — Gmail OAuth connections and GmailPilot labels.
  ...
  - `0010_gmail_mailbox_uniqueness.sql` — one active Gmail inbox (`gmail_email` / Google account) per GmailPilot user.
